...
<section class="content-header"> 
    <h1>Slidder Themes  </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home" style="font-size:20px;"></i> Home</a></li>
        <li class="active"><a href="<?php echo ADMIN_URL.'slidder'; ?>">Slidder Theme List</a></li>
    </ol>
</section>
						...
						<div class="box-group" id="accordion">
						    <div class="box-primary">
							   	<div class="box-header" style="border-bottom:1px solid #ccc;">
									<h3 class="box-title">Slidder Theme List</h3>
							   	</div>
								<div class="box-body">	
								<?php
									  $actionField = array(
								  ...
								  echo $this->Datatable->getDatatable($slidder_theme_detail,'SlidderThemeList','datatable table-responsive table-condensed table-hover',array(),$actionField);
								  ?>
								  </div>
							   </div>
						    </div>                                       
...
<script type="text/javascript">
	jQuery(document).ready(function(e) {
		setMenu('slidderMenu', '');
		$('#SlidderThemeList td:last-child a').each(function(){
		...
		$("#SlidderThemeList td:last-child a .iCheck-helper").click(function(){ 
			var id=$(this).attr('id');
			window.location.href='/keyurWork/index.php/admin/slidder/remove/'+id;
		});
		$("#ThemeTable td:last-child a .iCheck-helper").click(function(){ 
			var id=$(this).attr('id');
			window.location.href='/keyurWork/index.php/admin/slidder/add/'+id;
		});
		jQuery("#SlidderThemeList").dataTable({
			"bPaginate": true,
			"bLengthChange": true,
			"bFilter": true,
			"bSort": true,
