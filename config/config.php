...
define('UPLOAD_THEME_IMAGES','/uploads/theme_images/');
define('UPLOAD_THEME_PREVIEW','/uploads/theme_preview/');
define('UPLOAD_GREED_IMAGES','/uploads/greed_images/');
define('UPLOAD_GREED_PREVIEW','/uploads/greed_preview/');
define('UPLOAD_THEME_VIDEO','/uploads/theme_video/');
